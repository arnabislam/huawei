            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                        ...
                        const Column(
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text("English", style: TextStyle(color: Colors.blue, fontSize: 13, fontWeight: FontWeight.bold)),
                                Text("|", style: TextStyle(color: Colors.grey)),
                                Text("Eng", style: TextStyle(color: Colors.blue)),
                              ],
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text("Version", style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold)),
                                Text(":", style: TextStyle(color: Colors.grey)),
                                Text("7.2", style: TextStyle(color: Colors.black)),
                              ],
                            ),
                          ],
                        ),
                  ...
                  SizedBox(height: 25,),
                  Text("Visit Our Website",style: TextStyle(color: Colors.blue,fontSize: 14,fontWeight: FontWeight.bold),),
                  SizedBox(height: 15,),
                  Text("Copyright 2018. All rights reserved",style: TextStyle(fontSize: 10,color: Colors.black),)
                ],
              ),
            ),
          ],
