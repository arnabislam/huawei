            ...
            Container(
              child: Column(
                children: [
                  ...
                  const Text("Package GD LOTTO",style: TextStyle(fontSize: 25,color: Colors.red,fontWeight: FontWeight.bold),),
                  Padding(
                    padding: const EdgeInsets.only(left: 25.0, right: 25),
                    child: Table(
                      columnWidths: const {
                  ...
                  const SizedBox(height: 15,),
                  const Text("Package NINE",style: TextStyle(fontSize: 25,color: Colors.red,fontWeight: FontWeight.bold),),
                  Padding(
                    padding: const EdgeInsets.only(left: 25.0, right: 25),
                    child: Table(
                      columnWidths: const {
...
class tableContainer extends StatelessWidget {
  ...
  const tableContainer({
    required this.text1,required this.text2,required this.text3,required this.text4,required this.text5,required this.text6,
    super.key,
  });
      ...
      child:  Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(text2),SizedBox(width: 10,) ,  Text(text3),  SizedBox(width: 10,) , Text(text4),
            ],
          ),
          SizedBox(height: 4,),
          Row(
            ...
            children: [
               Text(text5),  SizedBox(width: 10,) , Text(text6),
            ],
          ),
        ],
      ),
